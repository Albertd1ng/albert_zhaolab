...
def start_multi_stitch(layer_num, info_IO_path, img_file_type, img_path, img_name_format, img_name,
    ...
    np.save(os.path.join(info_IO_path, 'tile_shift_arr_%.4d.npy' % layer_num), tile_shift_arr)
    np.save(os.path.join(info_IO_path, 'tile_shift_loss_%.4d.npy' % layer_num), tile_shift_loss)

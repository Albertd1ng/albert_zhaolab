...
def get_two_strip_border(strip_pos, xy_v_num, z_v_num):
    '''
    Get the border indices of overlapped area for two contacted strips.

    :param strip_pos: numpy.array((2, 3), dtype='int64').
        the xyz positions of two strips.
    :param xy_v_num: numpy.array(2, dtype='int64').
        the voxel quantity in xy dimensions.
    :param z_v_num: numpy.array(2, dtype='int64').
            the voxel quantity in z dimension of two strips.
    :return:
        border: numpy.array((2, 6), dtype='int64')
            the border of overlapped area of two strips.
...
def get_two_strip_sec_border(strip_pos_sec, xy_v_num, z_depth):
    '''
    Get the border indices of overlapped area for two contacted strip sections.
    :param strip_pos_sec: vector(6) or array(2,3), dtype='int64'.
    :param xy_v_num: numpy.array(2, dtype='int64').
        the voxel quantity in xy dimensions.
    :param z_depth: int.
    :return:
